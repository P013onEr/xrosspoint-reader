...
INTERVAL_PRESETS = {
    ...
    # CJK UI coverage: Latin UI labels, CJK punctuation, kana, Hangul, CJK
    # ideographs, compatibility ideographs, and fullwidth forms.
    "cjk-ui":      [(0x0020, 0x007E), (0x2000, 0x206F), (0x3000, 0x303F),
                    (0x3040, 0x309F), (0x30A0, 0x30FF), (0x3130, 0x318F),
                    (0x4E00, 0x9FFF), (0xAC00, 0xD7AF), (0xF900, 0xFAFF),
                    (0xFF00, 0xFFEF)],
    # CJK reading coverage: built-in Latin/European coverage plus CJK UI
    # coverage and common symbol blocks used in ebooks.
    "cjk-reading": [(0x0000, 0x024F), (0x0300, 0x036F), (0x0400, 0x052F),
                    (0x1E00, 0x1EFF), (0x1EA0, 0x1EF9), (0x2000, 0x206F),
                    ...
                    (0x3130, 0x318F), (0x4E00, 0x9FFF), (0xAC00, 0xD7AF),
                    (0xF900, 0xFAFF), (0xFB00, 0xFB06), (0xFF00, 0xFFEF)],
